...
CoreApp.PurchaseConfirmationPane = CoreOs.ModalPane.extend({
    ...
    ContentView: CoreOs.View.extend({
        ...
        Header: CoreOs.LabelView.extend({
            classNames: ['header'],
            title: Alto.String.loc('ENCOUNTER_LICENSE_CONFIRMATION_HEADER')
        }),
        ...
        PurchaseContainer: CoreOs.View.extend({
            ...
            SetupFeeFrame: CoreOs.View.extend({
                ...
                Text: CoreOs.LabelView.extend({
                    classNames: ['text'],
                    title: Alto.String.loc('SETUP_FEE_LABEL')
                }),
